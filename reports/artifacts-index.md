...
_Generated: 2026-09-12 01:44 UTC_
...
|---|---|---|
| API Reference — Redoc | [Open](https://github.com/faserrao/c2m-api-v2-postman-artifacts/blob/main/docs/redoc.html) | Interactive API documentation rendered with Redoc — browse endpoints, schemas, and examples. |
| API Reference — Swagger UI | [Open](https://github.com/faserrao/c2m-api-v2-postman-artifacts/blob/main/docs/swagger.html) | Interactive API documentation rendered with Swagger UI — supports try-it-out requests. |
| API Reference — Stoplight Elements | [Open](https://github.com/faserrao/c2m-api-v2-postman-artifacts/blob/main/docs/elements.html) | Interactive API documentation rendered with Stoplight Elements. |
...
| Newman Test Run (latest) | [View](https://github.com/faserrao/c2m-api-v2-postman-artifacts/blob/main/reports/newman-c2mapiv2-test-collection-fixed-20260912-014431.html) | Most recent Newman end-to-end test run against the live API — HTML report with request/response details and pass/fail counts. |
| Collection Validation Report (latest) | [View](https://github.com/faserrao/c2m-api-v2-postman-artifacts/blob/main/reports/validation-20260912-014441.md) | Most recent per-endpoint conformance validation showing any fields that don't match the spec. |
