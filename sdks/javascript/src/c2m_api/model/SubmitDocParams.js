...
/**
 * The SubmitDocParams model module.
 * @module c2m_api/model/SubmitDocParams
 * @version 2.0.0
 */
class SubmitDocParams {
    /**
     * Constructs a new <code>SubmitDocParams</code>.
     * @alias module:c2m_api/model/SubmitDocParams
    ...
    constructor(docSourceAll, recipientAddressSource) { 
        ...
        SubmitDocParams.initialize(this, docSourceAll, recipientAddressSource);
    }
    ...
    /**
     * Constructs a <code>SubmitDocParams</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:c2m_api/model/SubmitDocParams} obj Optional instance to populate.
     * @return {module:c2m_api/model/SubmitDocParams} The populated <code>SubmitDocParams</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubmitDocParams();
    ...
    /**
     * Validates the JSON data with respect to <code>SubmitDocParams</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubmitDocParams</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SubmitDocParams.RequiredProperties) {
...
SubmitDocParams.RequiredProperties = ["docSourceAll", "recipientAddressSource"];

/**
 * @member {String} jobTemplate
 */
SubmitDocParams.prototype['jobTemplate'] = undefined;

/**
 * @member {module:c2m_api/model/DocSourceAll} docSourceAll
 */
SubmitDocParams.prototype['docSourceAll'] = undefined;

/**
 * @member {module:c2m_api/model/RecipientAddressSource} recipientAddressSource
 */
SubmitDocParams.prototype['recipientAddressSource'] = undefined;

/**
 * @member {module:c2m_api/model/PaymentDetails} paymentDetails
 */
SubmitDocParams.prototype['paymentDetails'] = undefined;

/**
 * @member {module:c2m_api/model/ReturnAddress} returnAddress
 */
SubmitDocParams.prototype['returnAddress'] = undefined;

/**
 * @member {module:c2m_api/model/JobOptions} jobOptions
 */
SubmitDocParams.prototype['jobOptions'] = undefined;

/**
 * @member {Array.<String>} tags
 */
SubmitDocParams.prototype['tags'] = undefined;
...
export default SubmitDocParams;
