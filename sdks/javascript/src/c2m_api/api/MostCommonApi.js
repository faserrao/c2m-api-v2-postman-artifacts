...
/**
* MostCommon service.
* @module c2m_api/api/MostCommonApi
* @version 2.0.0
*/
export default class MostCommonApi {

    /**
    * Constructs a new MostCommonApi. 
    * @alias module:c2m_api/api/MostCommonApi
    * @class
    ...
    */
     ...
     * @callback module:c2m_api/api/MostCommonApi~submitMultiDocMergeParamsCallback
     ...
     * @param {module:c2m_api/api/MostCommonApi~submitMultiDocMergeParamsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:c2m_api/api/MostCommonApi~submitMultiDocParamsCallback
     * @param {String} error Error message, if any.
     * @param {module:c2m_api/model/StandardResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:c2m_api/api/MostCommonApi~submitMultiDocParamsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:c2m_api/model/StandardResponse}
     */
     ...
     * @callback module:c2m_api/api/MostCommonApi~submitSingleDocParamsCallback
     * @param {String} error Error message, if any.
     * @param {module:c2m_api/model/StandardResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:c2m_api/api/MostCommonApi~submitSingleDocParamsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:c2m_api/model/StandardResponse}
     */
