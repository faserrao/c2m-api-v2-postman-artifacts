...
/**
* Recommended service.
* @module c2m_api/api/RecommendedApi
* @version 2.0.0
*/
export default class RecommendedApi {

    /**
    * Constructs a new RecommendedApi. 
    * @alias module:c2m_api/api/RecommendedApi
    * @class
    ...
    */
     ...
     * @callback module:c2m_api/api/RecommendedApi~submitMultiDocMergeParamsCallback
     ...
     * @param {module:c2m_api/api/RecommendedApi~submitMultiDocMergeParamsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:c2m_api/api/RecommendedApi~submitMultiDocParamsCallback
     * @param {String} error Error message, if any.
     * @param {module:c2m_api/model/StandardResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:c2m_api/api/RecommendedApi~submitMultiDocParamsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:c2m_api/model/StandardResponse}
     */
     ...
     * @callback module:c2m_api/api/RecommendedApi~submitSingleDocParamsCallback
     * @param {String} error Error message, if any.
     * @param {module:c2m_api/model/StandardResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:c2m_api/api/RecommendedApi~submitSingleDocParamsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:c2m_api/model/StandardResponse}
     */
