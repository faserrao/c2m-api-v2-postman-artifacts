...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.SubmitSinglePdfAddressCaptureParams();
  });
  ...
  describe('SubmitSinglePdfAddressCaptureParams', function() {
    it('should create an instance of SubmitSinglePdfAddressCaptureParams', function() {
      ...
      //var instance = new C2MApiV2.SubmitSinglePdfAddressCaptureParams();
      //expect(instance).to.be.a(C2MApiV2.SubmitSinglePdfAddressCaptureParams);
    });
