...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.ZipDocumentIdSource();
  });
  ...
  describe('ZipDocumentIdSource', function() {
    it('should create an instance of ZipDocumentIdSource', function() {
      // uncomment below and update the code to test ZipDocumentIdSource
      //var instance = new C2MApiV2AuthOverlay.ZipDocumentIdSource();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.ZipDocumentIdSource);
    });
