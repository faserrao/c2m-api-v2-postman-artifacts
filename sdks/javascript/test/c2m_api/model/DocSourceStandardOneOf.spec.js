...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.DocSourceStandardOneOf();
  });
  ...
  describe('DocSourceStandardOneOf', function() {
    it('should create an instance of DocSourceStandardOneOf', function() {
      // uncomment below and update the code to test DocSourceStandardOneOf
      //var instance = new C2MApiV2.DocSourceStandardOneOf();
      //expect(instance).to.be.a(C2MApiV2.DocSourceStandardOneOf);
    });
