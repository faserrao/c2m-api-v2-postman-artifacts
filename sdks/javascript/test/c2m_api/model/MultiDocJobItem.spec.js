...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.MultiDocJobItem();
  });
  ...
  describe('MultiDocJobItem', function() {
    it('should create an instance of MultiDocJobItem', function() {
      ...
      //var instance = new C2MApiV2AuthOverlay.MultiDocJobItem();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.MultiDocJobItem);
    });
