...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.ZipDocumentSourceOneOf();
  });
  ...
  describe('ZipDocumentSourceOneOf', function() {
    it('should create an instance of ZipDocumentSourceOneOf', function() {
      // uncomment below and update the code to test ZipDocumentSourceOneOf
      //var instance = new C2MApiV2.ZipDocumentSourceOneOf();
      //expect(instance).to.be.a(C2MApiV2.ZipDocumentSourceOneOf);
    });
