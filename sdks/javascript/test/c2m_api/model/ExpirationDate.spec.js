...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.ExpirationDate();
  });
  ...
  describe('ExpirationDate', function() {
    it('should create an instance of ExpirationDate', function() {
      // uncomment below and update the code to test ExpirationDate
      //var instance = new C2MApiV2.ExpirationDate();
      //expect(instance).to.be.a(C2MApiV2.ExpirationDate);
    });
