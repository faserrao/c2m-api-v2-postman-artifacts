...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.RecipientAddressSourceOneOf3();
  });
  ...
  describe('RecipientAddressSourceOneOf3', function() {
    it('should create an instance of RecipientAddressSourceOneOf3', function() {
      // uncomment below and update the code to test RecipientAddressSourceOneOf3
      //var instance = new C2MApiV2.RecipientAddressSourceOneOf3();
      //expect(instance).to.be.a(C2MApiV2.RecipientAddressSourceOneOf3);
    });
