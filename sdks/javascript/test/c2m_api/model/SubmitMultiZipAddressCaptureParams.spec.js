...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SubmitMultiZipAddressCaptureParams();
  });
  ...
  describe('SubmitMultiZipAddressCaptureParams', function() {
    it('should create an instance of SubmitMultiZipAddressCaptureParams', function() {
      // uncomment below and update the code to test SubmitMultiZipAddressCaptureParams
      //var instance = new C2MApiV2AuthOverlay.SubmitMultiZipAddressCaptureParams();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SubmitMultiZipAddressCaptureParams);
    });
    ...
    it('should have the property zipDocumentSource (base name: "zipDocumentSource")', function() {
      // uncomment below and update the code to test the property zipDocumentSource
      //var instance = new C2MApiV2AuthOverlay.SubmitMultiZipAddressCaptureParams();
      //expect(instance).to.be();
    });
