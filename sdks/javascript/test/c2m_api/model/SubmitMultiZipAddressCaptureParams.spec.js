...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.SubmitMultiZipAddressCaptureParams();
  });
  ...
  describe('SubmitMultiZipAddressCaptureParams', function() {
    it('should create an instance of SubmitMultiZipAddressCaptureParams', function() {
      ...
      //var instance = new C2MApiV2.SubmitMultiZipAddressCaptureParams();
      //expect(instance).to.be.a(C2MApiV2.SubmitMultiZipAddressCaptureParams);
    });
