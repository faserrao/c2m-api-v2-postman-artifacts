...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.LongTokenResponse();
  });
  ...
  describe('LongTokenResponse', function() {
    it('should create an instance of LongTokenResponse', function() {
      // uncomment below and update the code to test LongTokenResponse
      //var instance = new C2MApiV2.LongTokenResponse();
      //expect(instance).to.be.a(C2MApiV2.LongTokenResponse);
    });
