...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SubmitMultiDocMergeParams();
  });
  ...
  describe('SubmitMultiDocMergeParams', function() {
    it('should create an instance of SubmitMultiDocMergeParams', function() {
      // uncomment below and update the code to test SubmitMultiDocMergeParams
      //var instance = new C2MApiV2AuthOverlay.SubmitMultiDocMergeParams();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SubmitMultiDocMergeParams);
    });
    ...
    it('should have the property mergeDocumentSource (base name: "mergeDocumentSource")', function() {
      // uncomment below and update the code to test the property mergeDocumentSource
      //var instance = new C2MApiV2AuthOverlay.SubmitMultiDocMergeParams();
      //expect(instance).to.be();
    });
