...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.SubmitMultiDocMergeParams();
  });
  ...
  describe('SubmitMultiDocMergeParams', function() {
    it('should create an instance of SubmitMultiDocMergeParams', function() {
      ...
      //var instance = new C2MApiV2.SubmitMultiDocMergeParams();
      //expect(instance).to.be.a(C2MApiV2.SubmitMultiDocMergeParams);
    });
