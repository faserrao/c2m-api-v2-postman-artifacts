...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SubmitSinglePdfSplitParams();
  });
  ...
  describe('SubmitSinglePdfSplitParams', function() {
    it('should create an instance of SubmitSinglePdfSplitParams', function() {
      // uncomment below and update the code to test SubmitSinglePdfSplitParams
      //var instance = new C2MApiV2AuthOverlay.SubmitSinglePdfSplitParams();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SubmitSinglePdfSplitParams);
    });
    ...
    it('should have the property pdfSplitJobsWithAddress (base name: "pdfSplitJobsWithAddress")', function() {
      // uncomment below and update the code to test the property pdfSplitJobsWithAddress
      //var instance = new C2MApiV2AuthOverlay.SubmitSinglePdfSplitParams();
      //expect(instance).to.be();
    });
