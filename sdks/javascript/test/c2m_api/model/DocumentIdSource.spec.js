...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.DocumentIdSource();
  });
  ...
  describe('DocumentIdSource', function() {
    it('should create an instance of DocumentIdSource', function() {
      // uncomment below and update the code to test DocumentIdSource
      //var instance = new C2MApiV2.DocumentIdSource();
      //expect(instance).to.be.a(C2MApiV2.DocumentIdSource);
    });
