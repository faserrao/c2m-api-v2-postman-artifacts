...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.DocSourceZipFileRefOneOf();
  });
  ...
  describe('DocSourceZipFileRefOneOf', function() {
    it('should create an instance of DocSourceZipFileRefOneOf', function() {
      // uncomment below and update the code to test DocSourceZipFileRefOneOf
      //var instance = new C2MApiV2.DocSourceZipFileRefOneOf();
      //expect(instance).to.be.a(C2MApiV2.DocSourceZipFileRefOneOf);
    });
