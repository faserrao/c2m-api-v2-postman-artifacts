...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.DocSourceAll();
  });
  ...
  describe('DocSourceAll', function() {
    it('should create an instance of DocSourceAll', function() {
      // uncomment below and update the code to test DocSourceAll
      //var instance = new C2MApiV2AuthOverlay.DocSourceAll();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.DocSourceAll);
    });
