...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.MultiZipJobItem();
  });
  ...
  describe('MultiZipJobItem', function() {
    it('should create an instance of MultiZipJobItem', function() {
      // uncomment below and update the code to test MultiZipJobItem
      //var instance = new C2MApiV2AuthOverlay.MultiZipJobItem();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.MultiZipJobItem);
    });
