...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.RecipientAddressByList();
  });
  ...
  describe('RecipientAddressByList', function() {
    it('should create an instance of RecipientAddressByList', function() {
      // uncomment below and update the code to test RecipientAddressByList
      //var instance = new C2MApiV2.RecipientAddressByList();
      //expect(instance).to.be.a(C2MApiV2.RecipientAddressByList);
    });
