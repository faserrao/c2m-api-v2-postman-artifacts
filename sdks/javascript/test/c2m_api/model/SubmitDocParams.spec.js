...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.SubmitDocParams();
  });
  ...
  describe('SubmitDocParams', function() {
    it('should create an instance of SubmitDocParams', function() {
      // uncomment below and update the code to test SubmitDocParams
      //var instance = new C2MApiV2.SubmitDocParams();
      //expect(instance).to.be.a(C2MApiV2.SubmitDocParams);
    });
