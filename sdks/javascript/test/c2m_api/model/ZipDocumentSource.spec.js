...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.ZipDocumentSource();
  });
  ...
  describe('ZipDocumentSource', function() {
    it('should create an instance of ZipDocumentSource', function() {
      // uncomment below and update the code to test ZipDocumentSource
      //var instance = new C2MApiV2AuthOverlay.ZipDocumentSource();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.ZipDocumentSource);
    });
