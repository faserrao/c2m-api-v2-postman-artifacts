...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.PdfSplitJobItemWithAddress();
  });
  ...
  describe('PdfSplitJobItemWithAddress', function() {
    it('should create an instance of PdfSplitJobItemWithAddress', function() {
      // uncomment below and update the code to test PdfSplitJobItemWithAddress
      //var instance = new C2MApiV2AuthOverlay.PdfSplitJobItemWithAddress();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.PdfSplitJobItemWithAddress);
    });
