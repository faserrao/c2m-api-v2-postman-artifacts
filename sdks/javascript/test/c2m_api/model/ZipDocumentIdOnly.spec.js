...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.ZipDocumentIdOnly();
  });
  ...
  describe('ZipDocumentIdOnly', function() {
    it('should create an instance of ZipDocumentIdOnly', function() {
      // uncomment below and update the code to test ZipDocumentIdOnly
      //var instance = new C2MApiV2.ZipDocumentIdOnly();
      //expect(instance).to.be.a(C2MApiV2.ZipDocumentIdOnly);
    });
