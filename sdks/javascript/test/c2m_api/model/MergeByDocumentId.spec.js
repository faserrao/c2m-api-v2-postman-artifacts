...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.MergeByDocumentId();
  });
  ...
  describe('MergeByDocumentId', function() {
    it('should create an instance of MergeByDocumentId', function() {
      // uncomment below and update the code to test MergeByDocumentId
      //var instance = new C2MApiV2.MergeByDocumentId();
      //expect(instance).to.be.a(C2MApiV2.MergeByDocumentId);
    });
