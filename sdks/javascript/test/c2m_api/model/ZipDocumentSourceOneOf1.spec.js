...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.ZipDocumentSourceOneOf1();
  });
  ...
  describe('ZipDocumentSourceOneOf1', function() {
    it('should create an instance of ZipDocumentSourceOneOf1', function() {
      // uncomment below and update the code to test ZipDocumentSourceOneOf1
      //var instance = new C2MApiV2.ZipDocumentSourceOneOf1();
      //expect(instance).to.be.a(C2MApiV2.ZipDocumentSourceOneOf1);
    });
