...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.DocSourceStandardOneOf1();
  });
  ...
  describe('DocSourceStandardOneOf1', function() {
    it('should create an instance of DocSourceStandardOneOf1', function() {
      // uncomment below and update the code to test DocSourceStandardOneOf1
      //var instance = new C2MApiV2.DocSourceStandardOneOf1();
      //expect(instance).to.be.a(C2MApiV2.DocSourceStandardOneOf1);
    });
