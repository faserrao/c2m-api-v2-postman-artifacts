...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.CreditCardPayment();
  });
  ...
  describe('CreditCardPayment', function() {
    it('should create an instance of CreditCardPayment', function() {
      // uncomment below and update the code to test CreditCardPayment
      //var instance = new C2MApiV2.CreditCardPayment();
      //expect(instance).to.be.a(C2MApiV2.CreditCardPayment);
    });
