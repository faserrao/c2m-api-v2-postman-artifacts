...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SubmitSinglePdfSplitAddressCaptureParams();
  });
  ...
  describe('SubmitSinglePdfSplitAddressCaptureParams', function() {
    it('should create an instance of SubmitSinglePdfSplitAddressCaptureParams', function() {
      // uncomment below and update the code to test SubmitSinglePdfSplitAddressCaptureParams
      //var instance = new C2MApiV2AuthOverlay.SubmitSinglePdfSplitAddressCaptureParams();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SubmitSinglePdfSplitAddressCaptureParams);
    });
    ...
    it('should have the property pdfSplitJobsNoAddress (base name: "pdfSplitJobsNoAddress")', function() {
      // uncomment below and update the code to test the property pdfSplitJobsNoAddress
      //var instance = new C2MApiV2AuthOverlay.SubmitSinglePdfSplitAddressCaptureParams();
      //expect(instance).to.be();
    });
