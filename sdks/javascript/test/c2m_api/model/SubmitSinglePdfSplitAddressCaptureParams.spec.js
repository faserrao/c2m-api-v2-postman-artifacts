...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.SubmitSinglePdfSplitAddressCaptureParams();
  });
  ...
  describe('SubmitSinglePdfSplitAddressCaptureParams', function() {
    it('should create an instance of SubmitSinglePdfSplitAddressCaptureParams', function() {
      ...
      //var instance = new C2MApiV2.SubmitSinglePdfSplitAddressCaptureParams();
      //expect(instance).to.be.a(C2MApiV2.SubmitSinglePdfSplitAddressCaptureParams);
    });
