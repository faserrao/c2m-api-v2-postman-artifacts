...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.DocumentSource();
  });
  ...
  describe('DocumentSource', function() {
    it('should create an instance of DocumentSource', function() {
      // uncomment below and update the code to test DocumentSource
      //var instance = new C2MApiV2AuthOverlay.DocumentSource();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.DocumentSource);
    });
