...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2.RecipientAddressBySingle();
  });
  ...
  describe('RecipientAddressBySingle', function() {
    it('should create an instance of RecipientAddressBySingle', function() {
      // uncomment below and update the code to test RecipientAddressBySingle
      //var instance = new C2MApiV2.RecipientAddressBySingle();
      //expect(instance).to.be.a(C2MApiV2.RecipientAddressBySingle);
    });
