...
let apiInstance = new C2MApiV2AuthOverlay.JobsApi();
let submitMultiDocMergeParams = new C2MApiV2AuthOverlay.SubmitMultiDocMergeParams(); // SubmitMultiDocMergeParams | 
...
let apiInstance = new C2MApiV2AuthOverlay.JobsApi();
let submitMultiDocParams = new C2MApiV2AuthOverlay.SubmitMultiDocParams(); // SubmitMultiDocParams | 
...
let apiInstance = new C2MApiV2AuthOverlay.JobsApi();
let submitMultiZipAddressCaptureParams = new C2MApiV2AuthOverlay.SubmitMultiZipAddressCaptureParams(); // SubmitMultiZipAddressCaptureParams | 
...
let apiInstance = new C2MApiV2AuthOverlay.JobsApi();
let submitMultiZipParams = new C2MApiV2AuthOverlay.SubmitMultiZipParams(); // SubmitMultiZipParams | 
...
let apiInstance = new C2MApiV2AuthOverlay.JobsApi();
let submitSingleDocParams = new C2MApiV2AuthOverlay.SubmitSingleDocParams(); // SubmitSingleDocParams | 
...
let apiInstance = new C2MApiV2AuthOverlay.JobsApi();
let submitSinglePdfAddressCaptureParams = new C2MApiV2AuthOverlay.SubmitSinglePdfAddressCaptureParams(); // SubmitSinglePdfAddressCaptureParams | 
...
let apiInstance = new C2MApiV2AuthOverlay.JobsApi();
let submitSinglePdfSplitAddressCaptureParams = new C2MApiV2AuthOverlay.SubmitSinglePdfSplitAddressCaptureParams(); // SubmitSinglePdfSplitAddressCaptureParams | 
...
let apiInstance = new C2MApiV2AuthOverlay.JobsApi();
let submitSinglePdfSplitParams = new C2MApiV2AuthOverlay.SubmitSinglePdfSplitParams(); // SubmitSinglePdfSplitParams | 
