...
public class Example {
  public static void main(String[] args) {
    ...
    SubmitDocParams submitDocParams = new SubmitDocParams(); // SubmitDocParams | 
    try {
      StandardResponse result = apiInstance.submitDocParams(submitDocParams);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling JobsApi#submitDocParams");
