...
import com.c2m.api.MostCommonApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    MostCommonApi apiInstance = new MostCommonApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling MostCommonApi#submitMultiDocMergeParams");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MostCommonApi#submitMultiDocParams");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MostCommonApi#submitSingleDocParams");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
