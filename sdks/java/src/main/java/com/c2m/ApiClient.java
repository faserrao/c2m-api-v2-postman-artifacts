...
import com.c2m.auth.Authentication;
import com.c2m.auth.HttpBasicAuth;
import com.c2m.auth.HttpBearerAuth;
import com.c2m.auth.ApiKeyAuth;
import com.c2m.auth.OAuth;
import com.c2m.auth.RetryingOAuth;
import com.c2m.auth.OAuthFlow;
...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("LongTokenAuth", new OAuth());
        authentications.put("ShortTokenAuth", new OAuth());
        authentications.put("ClientKey", new ApiKeyAuth("header", "X-Client-Id"));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "/auth/tokens/long";
     ...
     * @return a {@link com.c2m.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.c2m.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.c2m.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.c2m.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.c2m.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.c2m.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.c2m.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.c2m.ApiException If fails to update the parameters
     */
     ...
     * @throws com.c2m.ApiException If fail to serialize the request body object into a string
     */
