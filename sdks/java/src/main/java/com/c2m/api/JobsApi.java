...
public class JobsApi {
    ...
    /**
     * Build call for submitDocParams
     * @param submitDocParams  (required)
     ...
     */
    public okhttp3.Call submitDocParamsCall(@javax.annotation.Nonnull SubmitDocParams submitDocParams, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = submitDocParams;
    ...
    private okhttp3.Call submitDocParamsValidateBeforeCall(@javax.annotation.Nonnull SubmitDocParams submitDocParams, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'submitDocParams' is set
        if (submitDocParams == null) {
            throw new ApiException("Missing the required parameter 'submitDocParams' when calling submitDocParams(Async)");
        }

        return submitDocParamsCall(submitDocParams, _callback);
     ...
     */
    public StandardResponse submitDocParams(@javax.annotation.Nonnull SubmitDocParams submitDocParams) throws ApiException {
        ApiResponse<StandardResponse> localVarResp = submitDocParamsWithHttpInfo(submitDocParams);
     ...
     */
    public ApiResponse<StandardResponse> submitDocParamsWithHttpInfo(@javax.annotation.Nonnull SubmitDocParams submitDocParams) throws ApiException {
        okhttp3.Call localVarCall = submitDocParamsValidateBeforeCall(submitDocParams, null);
     ...
     */
    public okhttp3.Call submitDocParamsAsync(@javax.annotation.Nonnull SubmitDocParams submitDocParams, final ApiCallback<StandardResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = submitDocParamsValidateBeforeCall(submitDocParams, _callback);
        Type localVarReturnType = new TypeToken<StandardResponse>(){}.getType();
