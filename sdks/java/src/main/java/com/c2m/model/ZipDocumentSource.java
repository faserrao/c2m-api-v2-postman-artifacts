...
public class ZipDocumentSource extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<ZipDocumentSource>() {
                ...
                public void write(JsonWriter out, ZipDocumentSource value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: ZipDocumentSourceOneOf, ZipDocumentSourceOneOf1");
                }
     ...
     * ZipDocumentSourceOneOf, ZipDocumentSourceOneOf1
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be ZipDocumentSourceOneOf, ZipDocumentSourceOneOf1");
    }
     ...
     * ZipDocumentSourceOneOf, ZipDocumentSourceOneOf1
     *
     * @return The actual instance (ZipDocumentSourceOneOf, ZipDocumentSourceOneOf1)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for ZipDocumentSource with oneOf schemas: ZipDocumentSourceOneOf, ZipDocumentSourceOneOf1. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
