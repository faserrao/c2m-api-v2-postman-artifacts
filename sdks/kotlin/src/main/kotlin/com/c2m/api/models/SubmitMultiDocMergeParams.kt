...
data class SubmitMultiDocMergeParams (

    @Json(name = "mergeDocumentSource")
    val mergeDocumentSource: kotlin.collections.List<MergeDocumentRef>,
