...
class SubmitSinglePdfSplitAddressCaptureParamsTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of SubmitSinglePdfSplitAddressCaptureParams
        //val modelInstance = SubmitSinglePdfSplitAddressCaptureParams()
        ...
        // to test the property `pdfSplitJobsNoAddress`
        should("test pdfSplitJobsNoAddress") {
            // uncomment below to test the property
            //modelInstance.pdfSplitJobsNoAddress shouldBe ("TODO")
        }
