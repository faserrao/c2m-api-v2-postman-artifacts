...
try {
    ...
    println("4xx response calling MostCommonApi#submitMultiDocMergeParams")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling MostCommonApi#submitMultiDocMergeParams")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling MostCommonApi#submitMultiDocParams")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling MostCommonApi#submitMultiDocParams")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling MostCommonApi#submitSingleDocParams")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling MostCommonApi#submitSingleDocParams")
    e.printStackTrace()
}
```
