...
namespace C2M.Api.Model
{
    ...
    /// </summary>
    public partial class PdfSplitJobItemWithAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PdfSplitJobItemWithAddress" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="PdfSplitJobItemWithAddress" />
    /// </summary>
    public class PdfSplitJobItemWithAddressJsonConverter : JsonConverter<PdfSplitJobItemWithAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="PdfSplitJobItemWithAddress" />
        /// </summary>
        ...
        public override PdfSplitJobItemWithAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!startPage.IsSet)
                throw new ArgumentException("Property is required for class PdfSplitJobItemWithAddress.", nameof(startPage));

            if (!endPage.IsSet)
                throw new ArgumentException("Property is required for class PdfSplitJobItemWithAddress.", nameof(endPage));

            if (!recipientAddressSource.IsSet)
                throw new ArgumentException("Property is required for class PdfSplitJobItemWithAddress.", nameof(recipientAddressSource));

            if (startPage.IsSet && startPage.Value == null)
                throw new ArgumentNullException(nameof(startPage), "Property is not nullable for class PdfSplitJobItemWithAddress.");

            if (endPage.IsSet && endPage.Value == null)
                throw new ArgumentNullException(nameof(endPage), "Property is not nullable for class PdfSplitJobItemWithAddress.");
        ...
        /// <summary>
        /// Serializes a <see cref="PdfSplitJobItemWithAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="pdfSplitJobItemWithAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PdfSplitJobItemWithAddress pdfSplitJobItemWithAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, pdfSplitJobItemWithAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PdfSplitJobItemWithAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="pdfSplitJobItemWithAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PdfSplitJobItemWithAddress pdfSplitJobItemWithAddress, JsonSerializerOptions jsonSerializerOptions)
        {
