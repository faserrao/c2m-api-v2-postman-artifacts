...
namespace C2M.Api.Model
{
    ...
    /// DocSourceZipFile
    /// </summary>
    public partial class DocSourceZipFile : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocSourceZipFile {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="DocSourceZipFile" />
    /// </summary>
    public class DocSourceZipFileJsonConverter : JsonConverter<DocSourceZipFile>
    {
        /// <summary>
        /// Deserializes json to <see cref="DocSourceZipFile" />
        /// </summary>
        ...
        public override DocSourceZipFile Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="DocSourceZipFile" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="docSourceZipFile"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DocSourceZipFile docSourceZipFile, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, docSourceZipFile, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DocSourceZipFile" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="docSourceZipFile"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DocSourceZipFile docSourceZipFile, JsonSerializerOptions jsonSerializerOptions)
        {
