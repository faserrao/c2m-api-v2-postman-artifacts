...
namespace C2M.Api.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is PrioritySpec prioritySpec)
                return PrioritySpecValueConverter.ToJsonValue(prioritySpec);
            ...
            if (obj is SubmitSingleDocParams.PrioritySpecEnum submitSingleDocParamsPrioritySpecEnum)
                return SubmitSingleDocParams.PrioritySpecEnumToJsonValue(submitSingleDocParamsPrioritySpecEnum);
