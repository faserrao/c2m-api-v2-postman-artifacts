...
{
    /// <summary>
    ///  Class for testing MostCommonApi
    /// </summary>
    public sealed class MostCommonApiTests : ApiTestsBase
    {
        private readonly IMostCommonApi _instance;

        public MostCommonApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IMostCommonApi>();
        }
