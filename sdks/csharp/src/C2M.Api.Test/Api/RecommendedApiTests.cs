...
{
    /// <summary>
    ///  Class for testing RecommendedApi
    /// </summary>
    public sealed class RecommendedApiTests : ApiTestsBase
    {
        private readonly IRecommendedApi _instance;

        public RecommendedApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IRecommendedApi>();
        }
