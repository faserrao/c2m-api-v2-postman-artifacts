...
// Submit a multi doc merge job
TemplatesAPI.submitMultiDocMergeParams(submitMultiDocMergeParams: submitMultiDocMergeParams) { (response, error) in
...
// Submit a multi doc job
TemplatesAPI.submitMultiDocParams(submitMultiDocParams: submitMultiDocParams) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Submit a single doc job
TemplatesAPI.submitSingleDocParams(submitSingleDocParams: submitSingleDocParams) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
