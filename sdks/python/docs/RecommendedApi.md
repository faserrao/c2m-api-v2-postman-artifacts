...
with c2m_api.ApiClient(configuration) as api_client:
    ...
    api_instance = c2m_api.RecommendedApi(api_client)
    ...
    try:
        ...
        print("The response of RecommendedApi->submit_multi_doc_merge_params:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RecommendedApi->submit_multi_doc_merge_params: %s\n" % e)
```
...
with c2m_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RecommendedApi->submit_multi_doc_params:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RecommendedApi->submit_multi_doc_params: %s\n" % e)
```
...
with c2m_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RecommendedApi->submit_single_doc_params:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RecommendedApi->submit_single_doc_params: %s\n" % e)
```
