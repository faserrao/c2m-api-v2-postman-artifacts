...
class SubmitSinglePdfAddressCaptureParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["jobTemplate", "docSourceStandard", "paymentDetails", "returnAddress", "jobOptions", "tags"]
