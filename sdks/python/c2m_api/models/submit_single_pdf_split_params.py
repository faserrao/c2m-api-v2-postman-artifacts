...
class SubmitSinglePdfSplitParams(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in pdf_split_jobs_with_address (list)
        _items = []
        if self.pdf_split_jobs_with_address:
            for _item_pdf_split_jobs_with_address in self.pdf_split_jobs_with_address:
                if _item_pdf_split_jobs_with_address:
                    _items.append(_item_pdf_split_jobs_with_address.to_dict())
            _dict['pdfSplitJobsWithAddress'] = _items
