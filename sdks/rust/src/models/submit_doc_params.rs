...
impl SubmitDocParams {
    pub fn new(doc_source_all: models::DocSourceAll, recipient_address_source: models::RecipientAddressSource) -> SubmitDocParams {
        SubmitDocParams {
            job_template: None,
