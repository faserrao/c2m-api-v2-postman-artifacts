...
**zipDocumentSource** | [**ZipDocumentSource**](ZipDocumentSource.md) |  | [default to undefined]
...
```typescript
import { SubmitMultiZipAddressCaptureParams } from './api';

const instance: SubmitMultiZipAddressCaptureParams = {
    jobTemplate,
    zipDocumentSource,
    paymentDetails,
    returnAddress,
