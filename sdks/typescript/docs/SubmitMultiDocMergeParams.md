...
**mergeDocumentSource** | [**Array&lt;MergeDocumentRef&gt;**](MergeDocumentRef.md) |  | [default to undefined]
...
```typescript
import { SubmitMultiDocMergeParams } from './api';

const instance: SubmitMultiDocMergeParams = {
    jobTemplate,
    mergeDocumentSource,
