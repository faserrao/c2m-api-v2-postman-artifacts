...
/**
 * SubmitSinglePdfSplitParams Class Doc Comment
 *
 * @category Class
 * @package  C2MApi
 * @author   OpenAPI Generator team
 ...
 */
class SubmitSinglePdfSplitParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'submitSinglePdfSplitParams';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pdf_split_jobs_with_address'] === null) {
            $invalidProperties[] = "'pdf_split_jobs_with_address' can't be null";
        }
    ...
    /**
     * Gets pdf_split_jobs_with_address
     *
     * @return \C2MApi\Model\PdfSplitJobItemWithAddress[]
     */
    public function getPdfSplitJobsWithAddress()
    {
        return $this->container['pdf_split_jobs_with_address'];
    }

    /**
     * Sets pdf_split_jobs_with_address
     *
     * @param \C2MApi\Model\PdfSplitJobItemWithAddress[] $pdf_split_jobs_with_address pdf_split_jobs_with_address
     *
     * @return self
     */
    public function setPdfSplitJobsWithAddress($pdf_split_jobs_with_address)
    {
        if (is_null($pdf_split_jobs_with_address)) {
            throw new \InvalidArgumentException('non-nullable pdf_split_jobs_with_address cannot be null');
        }
        $this->container['pdf_split_jobs_with_address'] = $pdf_split_jobs_with_address;
