...
/**
 * SubmitSinglePdfSplitAddressCaptureParams Class Doc Comment
 *
 * @category Class
 * @package  C2MApi
 * @author   OpenAPI Generator team
 ...
 */
class SubmitSinglePdfSplitAddressCaptureParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'submitSinglePdfSplitAddressCaptureParams';
    ...
    protected static $openAPITypes = [
        ...
        'pdf_split_jobs_no_address' => '\C2MApi\Model\PdfSplitJobItemNoAddress[]',
    ...
    protected static array $openAPINullables = [
        ...
        'pdf_split_jobs_no_address' => false,
    ...
    protected static $attributeMap = [
        ...
        'pdf_split_jobs_no_address' => 'pdfSplitJobsNoAddress',
    ...
    protected static $setters = [
        ...
        'pdf_split_jobs_no_address' => 'setPdfSplitJobsNoAddress',
    ...
    protected static $getters = [
        ...
        'pdf_split_jobs_no_address' => 'getPdfSplitJobsNoAddress',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pdf_split_jobs_no_address', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['doc_source_standard'] === null) {
            $invalidProperties[] = "'doc_source_standard' can't be null";
        }
        if ($this->container['pdf_split_jobs_no_address'] === null) {
            $invalidProperties[] = "'pdf_split_jobs_no_address' can't be null";
        }
     ...
     *
     * @return \C2MApi\Model\DocSourceStandard
     */
    public function getDocSourceStandard()
    {
        return $this->container['doc_source_standard'];
    }

    /**
     * Sets doc_source_standard
     *
     * @param \C2MApi\Model\DocSourceStandard $doc_source_standard doc_source_standard
     *
     * @return self
     */
    public function setDocSourceStandard($doc_source_standard)
    {
        if (is_null($doc_source_standard)) {
            throw new \InvalidArgumentException('non-nullable doc_source_standard cannot be null');
        }
        $this->container['doc_source_standard'] = $doc_source_standard;

        return $this;
    }

    /**
     * Gets pdf_split_jobs_no_address
     *
     * @return \C2MApi\Model\PdfSplitJobItemNoAddress[]
     */
    public function getPdfSplitJobsNoAddress()
    {
        return $this->container['pdf_split_jobs_no_address'];
    }

    /**
     * Sets pdf_split_jobs_no_address
     *
     * @param \C2MApi\Model\PdfSplitJobItemNoAddress[] $pdf_split_jobs_no_address pdf_split_jobs_no_address
     *
     * @return self
     */
    public function setPdfSplitJobsNoAddress($pdf_split_jobs_no_address)
    {
        if (is_null($pdf_split_jobs_no_address)) {
            throw new \InvalidArgumentException('non-nullable pdf_split_jobs_no_address cannot be null');
        }
        $this->container['pdf_split_jobs_no_address'] = $pdf_split_jobs_no_address;
