...
/**
 * SubmitMultiZipAddressCaptureParams Class Doc Comment
 *
 * @category Class
 * @package  C2MApi
 * @author   OpenAPI Generator team
 ...
 */
class SubmitMultiZipAddressCaptureParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'submitMultiZipAddressCaptureParams';
    ...
    protected static $openAPITypes = [
        'job_template' => 'string',
        'zip_document_source' => '\C2MApi\Model\ZipDocumentSource',
    ...
    protected static $attributeMap = [
        ...
        'zip_document_source' => 'zipDocumentSource',
    ...
    protected static $setters = [
        ...
        'zip_document_source' => 'setZipDocumentSource',
    ...
    protected static $getters = [
        ...
        'zip_document_source' => 'getZipDocumentSource',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('zip_document_source', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['zip_document_source'] === null) {
            $invalidProperties[] = "'zip_document_source' can't be null";
        }
    ...
    /**
     * Gets zip_document_source
     *
     * @return \C2MApi\Model\ZipDocumentSource
     */
    public function getZipDocumentSource()
    {
        return $this->container['zip_document_source'];
    }

    /**
     * Sets zip_document_source
     *
     * @param \C2MApi\Model\ZipDocumentSource $zip_document_source zip_document_source
     *
     * @return self
     */
    public function setZipDocumentSource($zip_document_source)
    {
        if (is_null($zip_document_source)) {
            throw new \InvalidArgumentException('non-nullable zip_document_source cannot be null');
        }
        $this->container['zip_document_source'] = $zip_document_source;
