...
/**
 * SubmitMultiDocMergeParams Class Doc Comment
 *
 * @category Class
 * @package  C2MApi
 * @author   OpenAPI Generator team
 ...
 */
class SubmitMultiDocMergeParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'submitMultiDocMergeParams';
    ...
    protected static $openAPITypes = [
        'job_template' => 'string',
        'merge_document_source' => '\C2MApi\Model\MergeDocumentRef[]',
    ...
    protected static $attributeMap = [
        ...
        'merge_document_source' => 'mergeDocumentSource',
    ...
    protected static $setters = [
        ...
        'merge_document_source' => 'setMergeDocumentSource',
    ...
    protected static $getters = [
        ...
        'merge_document_source' => 'getMergeDocumentSource',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('merge_document_source', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['merge_document_source'] === null) {
            $invalidProperties[] = "'merge_document_source' can't be null";
        }
    ...
    /**
     * Gets merge_document_source
     *
     * @return \C2MApi\Model\MergeDocumentRef[]
     */
    public function getMergeDocumentSource()
    {
        return $this->container['merge_document_source'];
    }

    /**
     * Sets merge_document_source
     *
     * @param \C2MApi\Model\MergeDocumentRef[] $merge_document_source merge_document_source
     *
     * @return self
     */
    public function setMergeDocumentSource($merge_document_source)
    {
        if (is_null($merge_document_source)) {
            throw new \InvalidArgumentException('non-nullable merge_document_source cannot be null');
        }
        $this->container['merge_document_source'] = $merge_document_source;
