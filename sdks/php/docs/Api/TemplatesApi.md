...
$apiInstance = new C2MApi\Api\TemplatesApi(
...
try {
    ...
    echo 'Exception when calling TemplatesApi->submitMultiDocMergeParams: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling TemplatesApi->submitMultiDocParams: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling TemplatesApi->submitSingleDocParams: ', $e->getMessage(), PHP_EOL;
}
```
