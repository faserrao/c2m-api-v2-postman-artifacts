...
$apiInstance = new C2MApi\Api\RecommendedApi(
...
try {
    ...
    echo 'Exception when calling RecommendedApi->submitMultiDocMergeParams: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RecommendedApi->submitMultiDocParams: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RecommendedApi->submitSingleDocParams: ', $e->getMessage(), PHP_EOL;
}
```
