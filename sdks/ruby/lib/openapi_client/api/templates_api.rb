  ...
  class TemplatesApi
    ...
    def submit_multi_doc_merge_params_with_http_info(submit_multi_doc_merge_params, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TemplatesApi.submit_multi_doc_merge_params ...'
      end
      ...
      if @api_client.config.client_side_validation && submit_multi_doc_merge_params.nil?
        fail ArgumentError, "Missing the required parameter 'submit_multi_doc_merge_params' when calling TemplatesApi.submit_multi_doc_merge_params"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"TemplatesApi.submit_multi_doc_merge_params",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TemplatesApi#submit_multi_doc_merge_params\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def submit_multi_doc_params_with_http_info(submit_multi_doc_params, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TemplatesApi.submit_multi_doc_params ...'
      end
      ...
      if @api_client.config.client_side_validation && submit_multi_doc_params.nil?
        fail ArgumentError, "Missing the required parameter 'submit_multi_doc_params' when calling TemplatesApi.submit_multi_doc_params"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"TemplatesApi.submit_multi_doc_params",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TemplatesApi#submit_multi_doc_params\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def submit_single_doc_params_with_http_info(submit_single_doc_params, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TemplatesApi.submit_single_doc_params ...'
      end
      ...
      if @api_client.config.client_side_validation && submit_single_doc_params.nil?
        fail ArgumentError, "Missing the required parameter 'submit_single_doc_params' when calling TemplatesApi.submit_single_doc_params"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"TemplatesApi.submit_single_doc_params",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TemplatesApi#submit_single_doc_params\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
