...
module OpenapiClient
  class ErrorResponse
    ...
    attr_accessor :error_tracking_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'error_tracking_id')
        self.error_tracking_id = attributes[:'error_tracking_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          error_tracking_id == o.error_tracking_id
    end
    ...
    def hash
      [error_type, error_message, error_code, error_details, error_tracking_id].hash
    end
