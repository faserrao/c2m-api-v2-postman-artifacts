...
module OpenapiClient
  class Address
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Address`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'foo1')
        self.foo1 = attributes[:'foo1']
      end

      if attributes.key?(:'foo2')
        self.foo2 = attributes[:'foo2']
      end
    end
    ...
    def hash
      [first_name, last_name, address1, city, state, zip, country, address2, address3, foo1, foo2].hash
    end
