...
# Unit tests for OpenapiClient::MostCommonApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'MostCommonApi' do
  before do
  ...
  describe 'test an instance of MostCommonApi' do
    it 'should create an instance of MostCommonApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::MostCommonApi)
    end
  end
