...
api_instance = OpenapiClient::MostCommonApi.new
...
begin
  ...
  puts "Error when calling MostCommonApi->submit_multi_doc_merge_params: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MostCommonApi->submit_multi_doc_merge_params_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MostCommonApi->submit_multi_doc_params: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MostCommonApi->submit_multi_doc_params_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MostCommonApi->submit_single_doc_params: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MostCommonApi->submit_single_doc_params_with_http_info: #{e}"
end
```
